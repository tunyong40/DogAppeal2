      ...
      <div class="container" id="accordion">
        <div class="row justify-content-center" data-aos="fade-up">
          <div class="col-lg-6 text-center heading-section mb-5">
            ...
            <h2 class="text-black mb-2 mitr">ติดตามผลการร้องเรียน</h2>
          </div>
        </div>
        <div class="col-lg-12 order-lg-2 mb-5 mb-lg-0" data-aos="fade-up"  data-aos-delay="">
        <h4 class="text-black mitr">ค้นหาผลการร้องเรียน</h4>
        </div>
        <div class="row accordion justify-content-center block__76208">
          <div class="col-lg-12 order-lg-2 mb-5 mb-lg-0 " data-aos="fade-up"  data-aos-delay="">
            <input type="text" id="myInput" onKeyup="myFunction()" class="form-control mitr col-lg-12" placeholder="กรุณาใส่ชื่อผู้ร้องเรียน" title="Type in a name">
            <table class="table" style="width:100%;" id="myTable">
              <thead class="text-primary text-align-center mitr">
                ...
                <?php }else{?>
                  <?php foreach($allAppeal as $data){ ?>   
                    ...
                    <td class = "mitr"><?php echo $data["id"];?></td>
                      ...
                      <td>
                        <a href="detail_appeal.php?id=<?php echo $data["id"];?>" class="btn btn-warning">รายละเอียด</a>
                      </td>
                    </tr>
                  <?php } ?>
                <?php } ?>
