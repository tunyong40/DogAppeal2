...
if(isset($_POST["submit"])){
  ...
  saveRegister($_POST["firstname"],$_POST["lastname"],$_POST["telephone"],$_POST["email"],$_POST["address"],$_POST["goverment"],$_POST["username"],$_POST["password"]); 
                ...
                <div class="col-lg-5 mr-auto order-lg-1" data-aos="fade-up"  data-aos-delay="100">
                  <div class="row form-group">
                    <div class="col-md-6 ">
                      ...
                      <input type="text" id="amount" class="form-control" name="firstname" value="<?php echo $currentUser['firstname'];?>" required>
                    </div>
                    <div class="col-md-6 ">
                      <label for="fname">นามสกุล</label>
                      <input type="text" id="amount" class="form-control" name="lastname" value="<?php echo $currentUser['lastname'];?>" required>
                    </div>
                  </div>
                  <div class="row form-group">
                    <div class="col-md-6 ">
                      <label for="fname">หมายเลขโทรศัพท์</label>
                      <input type="text" id="amount" class="form-control" name="telephone" value="<?php echo $currentUser['telephone'];?>" required>
                    </div>
                    <div class="col-md-6 ">
                      <label for="fname">อีเมล์</label>
                      <input type="text" id="amount" class="form-control" name="email" value="<?php echo $currentUser['email'];?>" required>
                    </div>
                  </div>
                  <div class="row form-group">
                    <div class="col-md-12 ">
                  ...
                  <div class="row form-group">
                    <div class="col-md-12 ">
                      ...
                      <select class="form-control" name="goverment" >
                        <option value="เทศบาลนครหาดใหญ่" <?php if($currentUser['goverment']=="เทศบาลนครหาดใหญ่"){?> selected<?php } ?>>เทศบาลนครหาดใหญ่</option>
                        <option value="เทศบาลนครสงขลา" <?php if($currentUser['goverment']=="เทศบาลนครสงขลา"){?> selected<?php } ?>>เทศบาลนครสงขลา</option>
                      </select>
                    </div>
                  </div>
                  <div class="row form-group">
                    <div class="col-md-6 ">
                      ...
                      <input type="text" id="username" class="form-control" name="username" value="<?php echo $currentUser['username'];?>" required>
                    </div>
                    <div class="col-md-6 ">
                      <label for="fname">รหัสผ่าน</label>
                      <input type="text" id="password" class="form-control" name="password" value="<?php echo $currentUser['password'];?>" required>
                    </div>
                  </div>
                  <div class="row form-group">
                    <div class="col-md-12 ">
