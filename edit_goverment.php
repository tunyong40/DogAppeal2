...
?>
<?php
$currentGoverment = getCurrentGoverment($_GET["id"]);
if(isset($_POST["submit"])){
  if($_POST["id"] == ""){
    saveGoverment($_POST["goverment_name"]);
  }else{
    editGoverment($_POST["id"],$_POST["goverment_name"]);
  }
  

}
if($_GET["id"] == ""){
  $txtHead = "เพิ่มหน่วยงาน";
}else{
  $txtHead = "แก้ไขหน่วยงาน";
}
?>
        ...
        <section class="site-section" id="faq-section">
          <div class="container" id="accordion">
            ...
            <form name="prduct_detail_form" action="" method="post" enctype="multipart/form-data">
              <input type="hidden" id="id" class="form-control" name="id" value="<?php echo $currentGoverment['id'];?>">
              <div class="row accordion justify-content-center block__76208">
                ...
                <div class="col-lg-5 mr-auto order-lg-1" data-aos="fade-up"  data-aos-delay="100">
                  <div class="row form-group">
                    <div class="col-md-12 ">
                      <label for="fname">ชื่อหน่วยงาน</label>
                      <input type="text" id="amount" class="form-control" name="goverment_name" value="<?php echo $currentGoverment['goverment_name'];?>">
                    </div>
